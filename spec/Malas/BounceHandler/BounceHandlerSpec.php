...
class BounceHandlerSpec extends ObjectBehavior
{
    ...
    function it_should_have_messages_recipient_after_parsing() {
        ...
        $msg->getRecipient()->shouldBe('loreta.lapiniene@lt.g4s.com');
    }
    ...
    static function getMessageArray() {
    	return [
    		new Message(
                "Return-path: <>\r\n
      Envelope-to: edemo@mokesciu-sufleris.lt\r\n
      Delivery-date: Thu, 03 Nov 2016 12:23:49 +0200\r\n
      Received: from mail by e-merits.hostingas.lt with spam-scanned (Exim 4.72)\r\n
      \tid 1c2FBU-0002ES-TS\r\n
      \tfor edemo@mokesciu-sufleris.lt; Thu, 03 Nov 2016 12:23:48 +0200\r\n
      Received: from [209.85.215.67] (helo=mail-lf0-f67.google.com)\r\n
      \tby e-merits.hostingas.lt with esmtps (UNKNOWN:AES128-GCM-SHA256:128)\r\n
      \t(Exim 4.72)\r\n
      \tid 1c2FBU-0002EP-PW\r\n
      \tfor edemo@mokesciu-sufleris.lt; Thu, 03 Nov 2016 12:23:48 +0200\r\n
      Received: by mail-lf0-f67.google.com with SMTP id n3so2518536lfn.0\r\n
              for <edemo@mokesciu-sufleris.lt>; Thu, 03 Nov 2016 03:23:48 -0700 (PDT)\r\n
      ...
      Return-Path: <edemo@mokesciu-sufleris.lt>\r\n
      Received: from e-merits.hostingas.lt (e-merits.hostingas.lt. [109.235.64.142])\r\n
              by mx.google.com with ESMTPS id d186si6974451lfg.83.2016.10.27.21.52.15\r\n
              for <loreta.lapiniene@lt.g4s.com>\r\n
              (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);\r\n
              Thu, 27 Oct 2016 21:52:15 -0700 (PDT)\r\n
      Received-SPF: pass (google.com: domain of edemo@mokesciu-sufleris.lt designates 109.235.64.142 as permitted sender) client-ip=109.235.64.142;\r\n
      Authentication-Results: mx.google.com;\r\n
             spf=pass (google.com: domain of edemo@mokesciu-sufleris.lt designates 109.235.64.142 as permitted sender) smtp.mailfrom=edemo@mokesciu-sufleris.lt\r\n
      Received: from e-merits.hostingas.lt ([109.235.64.142] helo=[127.0.0.1])\r\n
      \tby e-merits.hostingas.lt with esmtpa (Exim 4.72)\r\n
      \t(envelope-from <edemo@mokesciu-sufleris.lt>)\r\n
      \tid 1bzxgD-0003q1-Q2\r\n
      \tfor loreta.lapiniene@lt.g4s.com; Fri, 28 Oct 2016 06:18:05 +0300\r\n
      ...
      From: =?utf-8?Q?Mokes=C4=8Di=C5=B3?= SUFLERIS\r\n
       <neatsakineti@mokesciu-sufleris.lt>\r\n
      To: loreta.lapiniene@lt.g4s.com\r\n
      MIME-Version: 1.0\r\n
      Content-Type: text/html; charset=utf-8\r\n
      Content-Transfer-Encoding: quoted-printable\r\n
      X-Sender: neatsakineti@mokesciu-sufleris.lt\r\n
      X-Gm-Spam: 0\r\n
      X-Gm-Phishy: 0\r\n
      \r\n
      ----- End of message -----\r\n
      ...
      Received: from mail by e-merits.hostingas.lt with spam-scanned (Exim 4.72)\r\n
      \tid 1c2TtN-0002Kj-5b\r\n
      \tfor edemo@mokesciu-sufleris.lt; Fri, 04 Nov 2016 04:06:05 +0200\r\n
      Received: from [194.135.87.24] (helo=lynas.serveriai.lt)\r\n
      \tby e-merits.hostingas.lt with esmtps (UNKNOWN:DHE-RSA-AES256-GCM-SHA384:256)\r\n
      \t(Exim 4.72)\r\n
      \tid 1c2TtN-0002Kg-4e\r\n
      \tfor edemo@mokesciu-sufleris.lt; Fri, 04 Nov 2016 04:06:05 +0200\r\n
      Received: from mail by lynas.serveriai.lt with local (Exim 4.84_2)\r\n
      \tid 1c2TtM-0003QR-Py\r\n
      \tfor edemo@mokesciu-sufleris.lt; Fri, 04 Nov 2016 04:06:04 +0200\r\n
      From: visita@vbgrupe.lt\r\n
      To: edemo@mokesciu-sufleris.lt\r\n
      ...
      Esant svarbiems klausimams kreipkitės el. paštu biuras@vbgrupe.lt arba tel. nr. 85 2041543.  \r\n
      \r\n
      ...
      Received: from mail by e-merits.hostingas.lt with local (Exim 4.72)\r\n
      \tid 1c2VhZ-0006zq-Tg\r\n
      \tfor edemo@mokesciu-sufleris.lt; Fri, 04 Nov 2016 06:02:01 +0200\r\n
      Date: Fri, 04 Nov 2016 06:02:01 +0200\r\n
      Message-Id: <E1c2VhZ-0006zq-Tg@e-merits.hostingas.lt>\r\n
      X-Failed-Recipients: finance@jurtinga.lt\r\n
      Auto-Submitted: auto-replied\r\n
      From: Mail Delivery System <Mailer-Daemon@e-merits.hostingas.lt>\r\n
      To: edemo@mokesciu-sufleris.lt\r\n
      ...
      \r\n
        finance@jurtinga.lt\r\n
          SMTP error from remote mail server after RCPT TO:<finance@jurtinga.lt>:\r\n
      ...
      \t(envelope-from <edemo@mokesciu-sufleris.lt>)\r\n
      \tid 1c2VhZ-0006zf-Lu\r\n
      \tfor finance@jurtinga.lt; Fri, 04 Nov 2016 06:02:01 +0200\r\n
